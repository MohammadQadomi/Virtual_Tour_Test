import { Cache, Texture, RGBAFormat, CubeTexture, EventDispatcher, VideoTexture, LinearFilter, SpriteMaterial, Sprite, Color, CanvasTexture, DoubleSide, Vector3, Mesh, BackSide, Object3D, SphereGeometry, MeshBasicMaterial, BufferGeometry, BufferAttribute, ShaderLib, BoxGeometry , ShaderMaterial, Matrix4, Vector2, Quaternion, PlaneGeometry, MathUtils as Math$1, MOUSE, PerspectiveCamera, OrthographicCamera, Euler, Scene, StereoCamera, WebGLRenderTarget, NearestFilter, WebGLRenderer, Raycaster, Frustum, REVISION as REVISION$1 } from 'https://cdn.jsdelivr.net/npm/three@0.155.0/build/three.module.js' /*'../../../lib/ThreeJS/build/three.module.js''../../three/build/three.min.js'*/;
// import { VRButton } from '../node_modules/three/examples/jsm/webxr/VRButton.js';

// const version="0.12.1";const dependencies={three:"^0.105.2"};
const version="0.12.1";const dependencies={three:"^0.155.0"};
...
const ImageLoader = {
    ...
    load: function ( url, onLoad = () => {}, onProgress = () => {}, onError = () => {} ) {
        ...
        if (/*process.env.npm_lifecycle_event !== 'test'*/false) {
...
const TextureLoader = {
    ...
    load: function ( url, onLoad = () => {}, onProgress, onError ) {
        ...
        ImageLoader.load( url, function ( image ) {
            ...
            texture.format = isJPEG ? RGBAFormat : RGBAFormat;
...
function Infospot ( scale = 300, imageSrc, animated ) {
    ...
    let postLoad = function ( texture ) {

        if ( !this.material ) { return; }

        let ratio = texture.image.width / texture.image.height;
        let textureScale = new Vector3();
...
Infospot.prototype = Object.assign( Object.create( Sprite.prototype ), {
     ...
     * @instance
     */
    addHoverText: function ( text, delta = 40, fontColor = 'white' ) {
        ...
        if ( !this.element ) {
            ...
            this.element.style.fontFamily = '"Neo Sans", sans-serif';
...
Widget.prototype = Object.assign( Object.create( EventDispatcher.prototype ), {
    ...
    createMenu: function () {
        ...
        style.fontFamily = '"Neo Sans", sans-serif';
        style.fontSize = '14px';
...
class Panorama extends Mesh {
    constructor(geometry, material) {
        super(geometry, material); // Correct way to call the parent constructor
        this.type = 'panorama';
    ...
    toggleInfospotVisibility(isVisible, delay = 0) {
        const visible = isVisible !== undefined ? isVisible : !this.isInfospotVisible;
    ...
    link(pano, position, imageScale = 300, titleText = '', imageSrc) {
        if (!position) {
            console.warn('Please specify infospot position for linking');
            return;
        }

        const scale = imageScale ?? pano.linkingImageScale ?? 300;
        const img = imageSrc ?? pano.linkingImageURL ?? DataImage.Arrow;

        const spot = new Infospot(scale, img);
        spot.position.copy(position);
        if (titleText) spot.addHoverText(titleText);
    ...
    fadeIn(duration = this.animationDuration) {
    ...
    fadeOut(duration = this.animationDuration) {
...
class ImagePanorama extends Panorama {
    constructor(image, _geometry, _material) {
        const radius = 5000;
        const geometry = _geometry || new SphereGeometry(radius, 60, 40);
    ...
    load(src) {
        ...
        if (!src) {
            ...
            // Load texture from an image element
    ...
    onLoad(texture) {
        ...
        window.requestAnimationFrame(super.onLoad.bind(this));
    }
...
function CubePanorama ( images = [] ){
    ...
    const geometry = new BoxGeometry( edgeLength, edgeLength, edgeLength );
...
LittlePlanet.prototype = Object.assign( Object.create( ImagePanorama.prototype ), {
    ...
    createGeometry: function ( size, ratio ) {
        ...
        return new PlaneGeometry( size, size * ratio );
...
function OrbitControls ( object, domElement ) {
    ...
    function onMouseWheel( event ) {
        ...
        if ( event.wheelDelta !== undefined ) { // WebKit / Opera / Explorer 9
            ...
            delta = - event.wheelDelta; // added to fix zooming by mouse scroll wheel
...
function CardboardEffect ( renderer ) {
    ...
    if (geometry.attributes.normal) {
        delete geometry.attributes.normal; // Directly delete the 'normal' attribute
    }
...
function Viewer ( options ) {
    ...
    this.renderer.xr.enabled = true;// Added by me
